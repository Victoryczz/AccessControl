...
-- ----------------------------
--  Records of `sys_acl_module` 权限模块表的记录
-- ----------------------------
BEGIN;
...
-- ----------------------------
--  Table structure for `sys_role_user` 角色用户关联关系表
-- ----------------------------
...
-- ----------------------------
--  Records of `sys_role_user` 角色用户关联关系表数据
-- ----------------------------
BEGIN;
...
-- ----------------------------
--  Table structure for `sys_role_acl` 角色权限管理关系表
-- ----------------------------
...
-- ----------------------------
--  Records of `sys_role_acl` 角色权限管理关系表数据
-- ----------------------------
BEGIN;
...
-- ----------------------------
--  Table structure for `sys_log`  操作更新权限日志表
-- ----------------------------
